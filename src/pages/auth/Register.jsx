...
*/}
      ...
      <section className="bg-secondary">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-tertiary lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl font-playfair">
                Welcome to <span className="oj font-iceberg">Ooja</span>
              </h2>

              <p className="mt-4 leading-relaxed text-white/90 font-montserrat">
                Your proper market experience. We offer you the opportunity to experience the best market experience. Please enter your details to register and enjoy the experience
              </p>
            </div>
          </section>
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              <div className="relative -mt-16 block lg:hidden">
                ...
                <h1 className="mt-2 text-2xl font-bold text-tertiary sm:text-3xl md:text-4xl">
                  Welcome to Squid 🦑
                </h1>
              ...
              className="mt-8 grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    className="mt-1 p-2 w-full rounded-md border-tertiary bg-white text-sm text-tertiary shadow-sm"
                  />
                </div>
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    ...
                    name="password"
                    onChange={handleChange}
                    className="mt-1 w-full p-2 rounded-md border-tertiary bg-white text-sm text-tertiary shadow-sm"
                  />
                </div>
                ...
                <div className="col-span-6">
                  <label htmlFor="MarketingAccept" className="flex gap-4">
                    <input
                      ...
                      className="size-5 rounded-md border-tertiary bg-white shadow-sm"
                    />
