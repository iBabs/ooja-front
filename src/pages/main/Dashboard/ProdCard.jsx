  ...
  return (
    <div className="group h-[350px] shadow-lg rounded-md w-56 overflow-hidden">
      ...
      <div className="p-5 space-y-1">
        <h3 className="text-primary font-bold text-lg ">{title.slice(0,20)}...</h3>
        <p>${price}</p>
        <p className="text-sm capitalize text-red-400">{category}</p>
        
        <button className="border rounded w-full border-primary transition-all duration-150 ease-linear
         group-hover:bg-primary group-hover:text-white">Add to Cart</button>
      </div>
